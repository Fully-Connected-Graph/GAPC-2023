        ...
        1072: function (e) {
            e.exports = (function (e) {
                ...
                function i(s) {
                    ...
                    var r = (t[s] = { exports: {}, id: s, loaded: !1 });
                    return (
                        e[s].call(r.exports, r, r.exports, i),
                        (r.loaded = !0),
                        r.exports
                    );
                }
                ...
                function (e, t, i) {
                    ...
                    function o(e, t, i) {
                        var a,
                            o = null,
                            u = function (e, t) {
                                i && i(e, t), o && o.visit(e, t);
                            },
                            h = 'function' == typeof i ? u : null,
                            c = !1;
                        if (t) {
                            ...
                            var l =
                                ...
                                t.attachComment;
                            (c || l) &&
                                (((o = new s.CommentHandler()).attach = l),
                                (t.comment = !0),
                                (h = u));
                        }
                        var p = !1;
                        t &&
                            ...
                            (a =
                                t && 'boolean' == typeof t.jsx && t.jsx
                                    ? new r.JSXParser(e, t, h)
                                    : new n.Parser(e, t, h));
                        var d = p ? a.parseModule() : a.parseScript();
                        return (
                            c && o && (d.comments = o.comments),
                            a.config.tokens && (d.tokens = a.tokens),
                            a.config.tolerant &&
                                (d.errors = a.errorHandler.errors),
                            d
                        );
                    }
                    (t.parse = o),
                        (t.parseModule = function (e, t, i) {
                            var s = t || {};
                            return (s.sourceType = 'module'), o(e, s, i);
                        }),
                        (t.parseScript = function (e, t, i) {
                            var s = t || {};
                            return (s.sourceType = 'script'), o(e, s, i);
                        }),
                        (t.tokenize = function (e, t, i) {
                            var s,
                                r = new a.Tokenizer(e, t);
                            s = [];
                            try {
                                for (;;) {
                        ...
                        r = (function () {
                            ...
                            return (
                                (e.prototype.insertInnerComments = function (
                                    ...
                                    if (
                                        e.type === s.Syntax.BlockStatement &&
                                        0 === e.body.length
                                    ) {
                                        for (
                                            var i = [],
                                                r = this.leading.length - 1;
                                            r >= 0;
                                            --r
                                        ) {
                                            var n = this.leading[r];
                                            t.end.offset >= n.start &&
                                                (i.unshift(n.comment),
                                ...
                                (e.prototype.findTrailingComments = function (
                                    ...
                                    if (this.trailing.length > 0) {
                                        for (
                                            var i = this.trailing.length - 1;
                                            i >= 0;
                                            --i
                                        ) {
                                            var s = this.trailing[i];
                                            s.start >= e.end.offset &&
                                                t.unshift(s.comment);
                                        }
                                    ...
                                    if (r && r.node.trailingComments) {
                                        ...
                                        n &&
                                            n.range[0] >= e.end.offset &&
                                            ((t = r.node.trailingComments),
                                ...
                                (e.prototype.findLeadingComments = function (
                                    ...
                                    if (t) {
                                        for (
                                            var r = t.leadingComments
                                                    ? t.leadingComments.length
                                                    : 0,
                                                n = r - 1;
                                            n >= 0;
                                            --n
                                        ) {
                                            var a = t.leadingComments[n];
                                            a.range[1] <= e.start.offset &&
                                                (i.unshift(a),
                                                t.leadingComments.splice(n, 1));
                                        }
                                        return (
                                            t.leadingComments &&
                                                0 ===
                                ...
                                (e.prototype.visitComment = function (e, t) {
                                    var i =
                                            'L' === e.type[0]
                                                ? 'Line'
                                                : 'Block',
                                        s = { type: i, value: e.value };
                                    if (
                                        (e.range && (s.range = e.range),
                                        e.loc && (s.loc = e.loc),
                    ...
                    function p(e) {
                        ...
                        switch (e.type) {
                            ...
                            case o.JSXSyntax.JSXNamespacedName:
                                t = p(e.namespace) + ':' + p(e.name);
                                break;
                            case o.JSXSyntax.JSXMemberExpression:
                                t = p(e.object) + '.' + p(e.property);
                        }
                        return t;
                    }
                    ...
                    var d = (function (e) {
                        ...
                        return (
                            ...
                            (t.prototype.scanXHTMLEntity = function (e) {
                                for (
                                    var t = '&', i = !0, s = !1, r = !1, a = !1;
                                    !this.scanner.eof() && i && !s;
                            ...
                            (t.prototype.lexJSX = function () {
                                ...
                                if (46 === e) {
                                    var o = this.scanner.source.charCodeAt(
                                        ...
                                        u = this.scanner.source.charCodeAt(
                                ...
                                if (
                                    n.Character.isIdentifierStart(e) &&
                                    92 !== e
                                ) {
                                    var i = this.scanner.index;
                                    for (
                                        ...
                                        var a = this.scanner.source.charCodeAt(
                                            this.scanner.index
                                        );
                                        if (
                                            n.Character.isIdentifierPart(a) &&
                                            92 !== a
                                        )
                                            ++this.scanner.index;
                                        else if (45 === a) ++this.scanner.index;
                                        else break;
                                    }
                                    return {
                                        type: 100,
                            ...
                            (t.prototype.parseJSXStringLiteralAttribute =
                                function () {
                                    var e = this.createJSXNode(),
                                        t = this.nextJSXToken();
                                    8 !== t.type &&
                                    ...
                                    return this.finalize(
                                        e,
                                        new u.Literal(t.value, i)
                                    );
                                }),
                            (t.prototype.parseJSXExpressionAttribute =
                                function () {
                                    var e = this.createJSXNode();
                                    this.expectJSX('{'),
                                        this.finishJSX(),
                                    ...
                                    return (
                                        ...
                                        this.finalize(
                                            e,
                                            new a.JSXExpressionContainer(t)
                                        )
                                    );
                                }),
                            ...
                            (t.prototype.parseJSXNameValueAttribute =
                                function () {
                                    var e = this.createJSXNode(),
                            ...
                            (t.prototype.parseJSXExpressionContainer =
                                function () {
                                    var e,
                                        t = this.createJSXNode();
                                    return (
                                        ...
                                        this.finalize(
                                            t,
                                            new a.JSXExpressionContainer(e)
                                        )
                                    );
                                }),
                            ...
                            (t.prototype.parseComplexJSXElement = function (e) {
                                for (var t = []; !this.scanner.eof(); ) {
                                    ...
                                    if (
                                        s.type === o.JSXSyntax.JSXOpeningElement
                                    ) {
                                        if (s.selfClosing) {
                                            var r = this.finalize(
                                                i,
                                                new a.JSXElement(s, [], null)
                                            );
                                            e.children.push(r);
                                        } else
                                            t.push(e),
                                    ...
                                    if (
                                        s.type === o.JSXSyntax.JSXClosingElement
                                    ) {
                                        e.closing = s;
                                        var n = p(e.opening.name);
                                        if (
                                            (n !== p(e.closing.name) &&
                                                this.tolerateError(
                            ...
                            (t.prototype.parseJSXElement = function () {
                                ...
                                if (!t.selfClosing) {
                                    ...
                                    (i = r.children), (s = r.closing);
                                }
                                return this.finalize(
                                    e,
                                    new a.JSXElement(t, i, s)
                                );
                            }),
                ...
                function (e, t, i) {
                    ...
                    (t.ArrayExpression = function (e) {
                        ...
                        (t.BinaryExpression = function (e, t, i) {
                            (this.type =
                                '||' === e || '&&' === e
                                    ? s.Syntax.LogicalExpression
                                    : s.Syntax.BinaryExpression),
                                (this.operator = e),
                                (this.left = t),
                                (this.right = i);
                        }),
                        ...
                        (t.ClassBody = function (e) {
                            (this.type = s.Syntax.ClassBody), (this.body = e);
                        }),
                        ...
                        (t.ForStatement = function (e, t, i, r) {
                        ...
                        (t.FunctionDeclaration = function (e, t, i, r) {
                            (this.type = s.Syntax.FunctionDeclaration),
                                (this.id = e),
                                (this.params = t),
                                (this.body = i),
                        ...
                        (t.FunctionExpression = function (e, t, i, r) {
                            (this.type = s.Syntax.FunctionExpression),
                                (this.id = e),
                                (this.params = t),
                                (this.body = i),
                        ...
                        (t.Identifier = function (e) {
                            (this.type = s.Syntax.Identifier), (this.name = e);
                        }),
                        ...
                        (t.MethodDefinition = function (e, t, i, r, n) {
                        ...
                        (t.Property = function (e, t, i, r, n, a) {
                        ...
                        (t.RegexLiteral = function (e, t, i, r) {
                            (this.type = s.Syntax.Literal),
                                (this.value = e),
                                (this.raw = t),
                        ...
                        l = (function () {
                            ...
                            return (
                                ...
                                (e.prototype.unexpectedTokenError = function (
                                    ...
                                    var i,
                                        s = t || n.Messages.UnexpectedToken;
                                    if (
                                        (e
                                            ? (!t &&
                                                  ((s =
                                ...
                                (e.prototype.tolerateUnexpectedToken =
                                    function (e, t) {
                                ...
                                (e.prototype.expectCommaSeparator =
                                    function () {
                                ...
                                (e.prototype.parsePrimaryExpression =
                                    function () {
                                        var e,
                                            t,
                                            i,
                                ...
                                (e.prototype.parseSpreadElement = function () {
                                    ...
                                    return this.finalize(
                                        e,
                                        new a.SpreadElement(t)
                                    );
                                }),
                                (e.prototype.parseArrayInitializer =
                                    function () {
                                        var e = this.createNode(),
                                            t = [];
                                        for (
                                ...
                                (e.prototype.parsePropertyMethodFunction =
                                    function () {
                                        var e = this.createNode(),
                                ...
                                (e.prototype.parsePropertyMethodAsyncFunction =
                                    function () {
                                        var e = this.createNode(),
                                            t = this.context.allowYield,
                                ...
                                (e.prototype.parseObjectPropertyKey =
                                    function () {
                                        var e,
                                            t = this.createNode(),
                                            i = this.nextToken();
                                    ...
                                    if (3 === s.type) {
                                        ...
                                        this.match('*')
                                            ...
                                            : ((u = this.match('[')),
                                              (r =
                                                  this.parseObjectPropertyKey()));
                                    var d = this.qualifiedPropertyName(
                                        this.lookahead
                                    );
                                    if (
                                        3 === s.type &&
                                        ...
                                        if (this.match('=')) {
                                            (this.context.firstCoverInitializedNameError =
                                                ...
                                                this.nextToken(),
                                                (c = !0);
                                            var m = this.isolateCoverGrammar(
                                                this.parseAssignmentExpression
                                            );
                                            o = this.finalize(
                                                i,
                                                new a.AssignmentPattern(p, m)
                                            );
                                        } else (c = !0), (o = p);
                                    } else
                                        this.throwUnexpectedToken(
                                ...
                                (e.prototype.parseTemplateHead = function () {
                                    ...
                                    return this.finalize(
                                        e,
                                        new a.TemplateElement(
                                            { raw: i, cooked: r },
                                            t.tail
                                        )
                                    );
                                }),
                                (e.prototype.parseTemplateElement =
                                    function () {
                                ...
                                (e.prototype.parseTemplateLiteral =
                                    function () {
                                        var e = this.createNode(),
                                            t = [],
                                            i = [],
                                        ...
                                        return this.finalize(
                                            e,
                                            new a.TemplateLiteral(i, t)
                                        );
                                    }),
                                (e.prototype.reinterpretExpressionAsPattern =
                                    function (e) {
                                        switch (e.type) {
                                ...
                                (e.prototype.parseGroupExpression =
                                    function () {
                                        var e;
                                        ...
                                        for (
                                            ...
                                            if (this.match('.')) {
                                                ...
                                                this.expect(']'),
                                                    (e = this.finalize(
                                                        this.startNode(t),
                                                        new a.ComputedMemberExpression(
                                                            e,
                                                            r
                                                        )
                                                    ));
                                                ...
                                                e = this.finalize(
                                                    this.startNode(t),
                                                    new a.TaggedTemplateExpression(
                                                        e,
                                                        h
                                                    )
                                                );
                                            } else break;
                                        return (this.context.allowIn = s), e;
                                    }),
                                ...
                                (e.prototype.parseLeftHandSideExpression =
                                    function () {
                                        s.assert(
                                ...
                                (e.prototype.parseUpdateExpression =
                                    function () {
                                        var e,
                                            t = this.lookahead;
                                        if (
                                            ...
                                            e = this.finalize(
                                                this.startNode(t),
                                                new a.UpdateExpression(o, e, r)
                                            );
                                        }
                                        return e;
                                    }),
                                (e.prototype.parseAwaitExpression =
                                    function () {
                                        var e = this.createNode();
                                        this.nextToken();
                                        ...
                                        return this.finalize(
                                            e,
                                            new a.AwaitExpression(t)
                                        );
                                    }),
                                (e.prototype.parseUnaryExpression =
                                    function () {
                                        var e;
                                        if (
                                            this.match('+') ||
                                ...
                                (e.prototype.parseExponentiationExpression =
                                    function () {
                                        var e = this.lookahead,
                                ...
                                (e.prototype.parseConditionalExpression =
                                    function () {
                                        var e = this.lookahead,
                                            t = this.inheritCoverGrammar(
                                ...
                                (e.prototype.checkPatternParam = function (
                                    ...
                                    e.simple =
                                        e.simple && t instanceof a.Identifier;
                                }),
                                (e.prototype.reinterpretAsCoverFormalsList =
                                    function (e) {
                                        var t,
                                            i = [e],
                                            s = !1;
                                ...
                                (e.prototype.parseStatementListItem =
                                    function () {
                                        var e;
                                        if (
                                            ((this.context.isAssignmentTarget =
                                ...
                                (e.prototype.isLexicalDeclaration =
                                    function () {
                                        var e = this.scanner.saveState();
                                        this.scanner.scanComments();
                                        var t = this.scanner.lex();
                                ...
                                (e.prototype.parseLexicalDeclaration =
                                    function (e) {
                                        ...
                                        return (
                                            ...
                                            this.finalize(
                                                t,
                                                new a.VariableDeclaration(r, i)
                                            )
                                        );
                                    }),
                                (e.prototype.parseBindingRestElement =
                                    function (e, t) {
                                        var i = this.createNode();
                                        this.expect('...');
                                ...
                                (e.prototype.parsePropertyPattern = function (
                                    ...
                                    if (3 === this.lookahead.type) {
                                        ...
                                        (n = this.match('[')),
                                            ...
                                            this.expect(':'),
                                            (s = this.parsePatternWithDefault(
                                                e,
                                                t
                                            ));
                                    return this.finalize(
                                        r,
                                        new a.Property('init', i, n, s, !1, o)
                                    );
                                }),
                                ...
                                (e.prototype.parsePatternWithDefault =
                                    function (e, t) {
                                ...
                                (e.prototype.parseVariableIdentifier =
                                    function (e) {
                                        var t = this.createNode(),
                                            i = this.nextToken();
                                        return (
                                ...
                                (e.prototype.parseVariableDeclaration =
                                    function (e) {
                                        var t = this.createNode(),
                                        ...
                                        return (
                                            ...
                                            this.finalize(
                                                t,
                                                new a.VariableDeclarator(i, s)
                                            )
                                        );
                                    }),
                                (e.prototype.parseVariableDeclarationList =
                                    function (e) {
                                        var t = { inFor: e.inFor },
                                            i = [];
                                        for (
                                ...
                                (e.prototype.parseVariableStatement =
                                    function () {
                                        var e = this.createNode();
                                ...
                                (e.prototype.parseExpressionStatement =
                                    function () {
                                        var e = this.createNode(),
                                ...
                                (e.prototype.parseForStatement = function () {
                                    ...
                                    return void 0 === e
                                        ? this.finalize(
                                              c,
                                              new a.ForStatement(s, r, o, i)
                                          )
                                        : h
                                        ? this.finalize(
                                              c,
                                              new a.ForInStatement(e, t, i)
                                          )
                                        : this.finalize(
                                              c,
                                              new a.ForOfStatement(e, t, i)
                                          );
                                }),
                                (e.prototype.parseContinueStatement =
                                    function () {
                                        var e = this.createNode();
                                        ...
                                        return (
                                            ...
                                            null !== t ||
                                                ...
                                                this.throwError(
                                                    n.Messages.IllegalContinue
                                                ),
                                            this.finalize(
                                                e,
                                                new a.ContinueStatement(t)
                                            )
                                        );
                                    }),
                                (e.prototype.parseBreakStatement = function () {
                                    ...
                                    return (
                                        ...
                                        null !== t ||
                                            ...
                                            this.throwError(
                                                n.Messages.IllegalBreak
                                            ),
                                        this.finalize(
                                            e,
                                            new a.BreakStatement(t)
                                        )
                                    );
                                }),
                                (e.prototype.parseReturnStatement =
                                    function () {
                                        this.context.inFunctionBody ||
                                            this.tolerateError(
                                                n.Messages.IllegalReturn
                                            );
                                        var e = this.createNode();
                                ...
                                (e.prototype.parseSwitchCase = function () {
                                    ...
                                    return this.finalize(
                                        t,
                                        new a.SwitchCase(e, i)
                                    );
                                }),
                                (e.prototype.parseSwitchStatement =
                                    function () {
                                        var e = this.createNode();
                                        ...
                                        return (
                                            ...
                                            this.finalize(
                                                e,
                                                new a.SwitchStatement(t, s)
                                            )
                                        );
                                    }),
                                (e.prototype.parseLabelledStatement =
                                    function () {
                                        var e,
                                            t = this.createNode(),
                                        ...
                                        if (
                                            ...
                                            Object.prototype.hasOwnProperty.call(
                                                ...
                                                this.throwError(
                                                    n.Messages.Redeclaration,
                                                    'Label',
                                                    i.name
                                                ),
                                                (this.context.labelSet[s] = !0);
                                            var r = void 0;
                                            ...
                                            delete this.context.labelSet[s],
                                                (e = new a.LabeledStatement(
                                                    i,
                                                    r
                                                ));
                                        } else
                                            this.consumeSemicolon(),
                                                (e = new a.ExpressionStatement(
                                                    i
                                                ));
                                        return this.finalize(t, e);
                                    }),
                                ...
                                (e.prototype.parseCatchClause = function () {
                                    ...
                                    this.context.strict &&
                                        ...
                                        this.tolerateError(
                                            n.Messages.StrictCatchVariable
                                        ),
                                        this.expect(')');
                                    var h = this.parseBlock();
                                    return this.finalize(
                                        e,
                                        new a.CatchClause(i, h)
                                    );
                                }),
                                ...
                                (e.prototype.parseTryStatement = function () {
                                    ...
                                    return (
                                        i ||
                                            s ||
                                            this.throwError(
                                                n.Messages.NoCatchOrFinally
                                            ),
                                        this.finalize(
                                            e,
                                            new a.TryStatement(t, i, s)
                                        )
                                    );
                                }),
                                (e.prototype.parseDebuggerStatement =
                                    function () {
                                        var e = this.createNode();
                                        return (
                                ...
                                (e.prototype.parseFunctionSourceElements =
                                    function () {
                                        var e = this.createNode();
                                        this.expect('{');
                                ...
                                (e.prototype.parseRestElement = function (e) {
                                    ...
                                    return (
                                        this.match('=') &&
                                            this.throwError(
                                                n.Messages.DefaultRestParameter
                                            ),
                                        this.match(')') ||
                                            this.throwError(
                                                n.Messages
                                ...
                                (e.prototype.parseFormalParameter = function (
                                    ...
                                    (e.simple =
                                        e.simple && i instanceof a.Identifier),
                                        e.params.push(i);
                                }),
                                ...
                                (e.prototype.parseFunctionDeclaration =
                                    function (e) {
                                        var t,
                                            i = this.createNode(),
                                            s =
                                        ...
                                        return (
                                            ...
                                            s
                                                ? this.finalize(
                                                      i,
                                                      new a.AsyncFunctionDeclaration(
                                                          o,
                                                          d,
                                                          f
                                                      )
                                ...
                                (e.prototype.parseFunctionExpression =
                                    function () {
                                        var e,
                                            t,
                                            i = this.createNode(),
                                        ...
                                        var l = this.parseFormalParameters(t),
                                            p = l.params,
                                            d = l.stricted;
                                        (t = l.firstRestricted),
                                            l.message && (e = l.message);
                                ...
                                (e.prototype.parseDirectivePrologues =
                                    function () {
                                        for (var e = null, t = []; ; ) {
                                            var i = this.lookahead;
                                            if (8 !== i.type) break;
                                ...
                                (e.prototype.parseSetterMethod = function () {
                                    ...
                                    1 !== i.params.length
                                        ? this.tolerateError(
                                              n.Messages.BadSetterArity
                                          )
                                        : i.params[0] instanceof
                                              a.RestElement &&
                                          this.tolerateError(
                                              n.Messages.BadSetterRestParameter
                                          );
                                    var s = this.parsePropertyMethod(i);
                                    return (
                                        (this.context.allowYield = t),
                                ...
                                (e.prototype.parseGeneratorMethod =
                                    function () {
                                        var e = this.createNode(),
                                            t = this.context.allowYield;
                                        this.context.allowYield = !0;
                                ...
                                (e.prototype.parseYieldExpression =
                                    function () {
                                        var e = this.createNode();
                                ...
                                (e.prototype.parseClassElementList =
                                    function () {
                                        var e = [],
                                            t = { value: !1 };
                                        for (
                                ...
                                (e.prototype.parseClassDeclaration = function (
                                    ...
                                    return (
                                        ...
                                        this.finalize(
                                            t,
                                            new a.ClassDeclaration(s, r, n)
                                        )
                                    );
                                }),
                                (e.prototype.parseClassExpression =
                                    function () {
                                        var e = this.createNode(),
                                ...
                                (e.prototype.parseModuleSpecifier =
                                    function () {
                                        var e = this.createNode();
                                        8 !== this.lookahead.type &&
                                            this.throwError(
                                        ...
                                        return this.finalize(
                                            e,
                                            new a.Literal(t.value, i)
                                        );
                                    }),
                                (e.prototype.parseImportSpecifier =
                                    function () {
                                        var e,
                                            t,
                                            i = this.createNode();
                                ...
                                (e.prototype.parseImportDefaultSpecifier =
                                    function () {
                                        var e = this.createNode(),
                                            t = this.parseIdentifierName();
                                        return this.finalize(
                                            e,
                                            new a.ImportDefaultSpecifier(t)
                                        );
                                    }),
                                (e.prototype.parseImportNamespaceSpecifier =
                                    function () {
                                        var e = this.createNode();
                                        this.expect('*'),
                                        ...
                                        return this.finalize(
                                            e,
                                            new a.ImportNamespaceSpecifier(t)
                                        );
                                    }),
                                (e.prototype.parseImportDeclaration =
                                    function () {
                                        this.context.inFunctionBody &&
                                            this.throwError(
                                                n.Messages
                                        ...
                                        return (
                                            ...
                                            this.finalize(
                                                t,
                                                new a.ImportDeclaration(i, e)
                                            )
                                        );
                                    }),
                                (e.prototype.parseExportSpecifier =
                                    function () {
                                        var e = this.createNode(),
                                            t = this.parseIdentifierName(),
                                            i = t;
                                        return (
                                            ...
                                            this.finalize(
                                                e,
                                                new a.ExportSpecifier(t, i)
                                            )
                                        );
                                    }),
                                (e.prototype.parseExportDeclaration =
                                    function () {
                                        this.context.inFunctionBody &&
                                            this.throwError(
                                                n.Messages
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                e = this.finalize(
                                                    t,
                                                    new a.ExportDefaultDeclaration(
                                                        i
                                                    )
                                                );
                                            } else if (
                    ...
                    var i = (function () {
                        ...
                        return (
                            ...
                            (e.prototype.tolerateError = function (e, t, i, s) {
                                ...
                                if (this.tolerant) this.recordError(r);
                                else throw r;
                            }),
                            e
                        );
                        ...
                        return (
                            ...
                            (e.prototype.scanComments = function () {
                                ...
                                for (
                                    ...
                                    } else if (60 !== i || this.isModule) break;
                                    else if (
                                        '!--' ===
                                        this.source.slice(
                                            this.index + 1,
                            ...
                            (e.prototype.scanUnicodeCodePointEscape =
                                function () {
                            ...
                            (e.prototype.scanBinaryLiteral = function (e) {
                                ...
                                return (
                                    ...
                                    !this.eof() &&
                                        ...
                                        (r.Character.isIdentifierStart(t) ||
                            ...
                            (e.prototype.scanRegExpFlags = function () {
                                for (var e = '', t = ''; !this.eof(); ) {
                                    ...
                                    if (
                                        ...
                                        break;
                                    if (
                                        (++this.index, '\\' !== i || this.eof())
                                    )
                                        (t += i), (e += i);
                                    else if (
                                        'u' === (i = this.source[this.index])
                                    ) {
                                        ++this.index;
                                        var s = this.index,
                            ...
                            (e.prototype.lex = function () {
                                ...
                                return r.Character.isIdentifierStart(e)
                                    ? this.scanIdentifier()
                                    : 40 === e || 41 === e || 59 === e
                                    ? this.scanPunctuator()
                                    : 39 === e || 34 === e
                ...
                function (e, t, i) {
                    ...
                    var s = i(10),
                        ...
                        a = (function () {
                            ...
                            return (
                                (e.prototype.beforeFunctionExpression =
                                    function (e) {
                                        return (
                                            [
                                                '(',

    ...
    [179],
    {
        ...
        928: function (e, t, r) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.hasBasePath = function (e) {
                    return n.pathHasPrefix(e, '/GAPC-2023');
                });
            var n = r(3210);
            ('function' == typeof t.default ||
                ('object' == typeof t.default && null !== t.default)) &&
            ...
            function eo(e) {
                ...
                !(function () {
                    ...
                    let e = Z(document.querySelectorAll('style[data-n-href]')),
                        t = new Set(
                            e.map((e) => e.getAttribute('data-n-href'))
                        ),
        ...
        2700: function (e, t, r) {
            ...
            let o = (e) => {
                ...
                return /\.[^/]+\/?$/.test(t)
                    ? ''.concat(n.removeTrailingSlash(t)).concat(r).concat(o)
                    : t.endsWith('/')
                ...
                if (((n = e), !o))
                    for (let e of ((o = !0), a))
                        try {
                            ...
                            console.warn(
                                'Failed to track '.concat(e, ' web-vital'),
                                t
                            );
                        }
            };
                    ...
                    if ('beforeInteractive' === c)
                        return r
                            ...
                            : (h.dangerouslySetInnerHTML &&
                                  ((h.children =
                                      h.dangerouslySetInnerHTML.__html),
        ...
        1003: function (e, t, r) {
            ...
            function N() {
                return (N = n(function* (e) {
                    let t = yield Promise.resolve(
                        e.router.pageLoader.getMiddleware()
                    );
                    if (!t) return !1;
            ...
            function U(e, t, r) {
                ...
                try {
                    n = new URL(
                        a.startsWith('#') ? e.asPath : e.pathname,
                        'http://n'
                    );
                } catch (e) {
                    n = new URL('/', 'http://n');
                        ...
                        let t = yield e.fetchData(),
                            r = yield (function (e, t, r) {
                                let n = {
                                    ...
                                    i =
                                        o ||
                                        t.headers.get('x-nextjs-matched-path'),
                                ...
                                if (
                                    ...
                                    if (i.startsWith('/')) {
                                        let t = y.parseRelativeUrl(i),
                                            a = R.getNextPathnameInfo(
                                                t.pathname,
                                                { nextConfig: n, parseData: !0 }
                                            ),
                                            l = s.removeTrailingSlash(
                                                a.pathname
                                            );
                                        return Promise.all([
                ...
                let {
                    ...
                    p = (e) =>
                        (function e(t, r, n) {
                            ...
                            method:
                                null != (t = null == e ? void 0 : e.method)
                                    ? t
                                    : 'GET',
                        })
                            .then((t) =>
                                t.ok &&
                                (null == e ? void 0 : e.method) === 'HEAD'
                                    ? {
                                          dataHref: r,
                                          response: t,
                                          text: '',
                ...
                change(e, t, r, o, i) {
                    ...
                    return n(function* () {
                        ...
                        if (!p && l.onlyAHashChange(U) && !q) {
                            ...
                            return (
                                J.events.emit('hashChangeComplete', r, k), !0
                            );
                        }
                        let Z = y.parseRelativeUrl(t),
                            { pathname: z, query: V } = Z;
                        try {
                        ...
                        l.urlIsNew(U) || q || (e = 'replaceState');
                        let X = r;
                        z = z ? s.removeTrailingSlash(x.removeBasePath(z)) : z;
                        let Y = s.removeTrailingSlash(z),
                            K =
                                r.startsWith('/') &&
                                y.parseRelativeUrl(r).pathname,
                            Q = !!(
                                K &&
                                Y !== K &&
                                (!g.isDynamicRoute(Y) ||
                        ...
                        try {
                            ...
                            if ('route' in s && ee) {
                                ...
                                if (
                                    ...
                                    let e =
                                        ...
                                        t = e;
                                    j.hasBasePath(t) &&
                                        (t = x.removeBasePath(t));
                                    let n = P.getRouteRegex(z),
                            ...
                            if ((s.__N_SSG || s.__N_SSP) && s.props) {
                                if (
                                    s.props.pageProps &&
                                    s.props.pageProps.__N_REDIRECT
                                ) {
                                    o.locale = !1;
                            ...
                            let S =
                                ...
                                !O &&
                                !q &&
                                A.compareRouterStates(b, l.state);
                            if (!S) {
                                try {
                                    yield l.set(b, s, m);
                                } catch (e) {
                ...
                prefetch(e) {
                    ...
                    return n(function* () {
                        ...
                        yield Promise.all([
                            ...
                            o.pageLoader[r.priority ? 'loadPage' : 'prefetch'](
                                m
                            ),
                        ]);
                    })();
                ...
                (t.formatNextPathnameInfo = function (e) {
                    ...
                    return (
                        (e.buildId || !e.trailingSlash) &&
                            (t = n.removeTrailingSlash(t)),
                        e.buildId &&
                            (t = o.addPathSuffix(
                                a.addPathPrefix(
                                    t,
                                    '/_next/data/'.concat(e.buildId)
                                ),
        ...
        670: function (e, t, r) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.execOnce = function (e) {
                    ...
                    return function () {
                        for (
                            var n = arguments.length, a = Array(n), o = 0;
                            o < n;
                            o++
                        )
                            a[o] = arguments[o];
                ...
                (t.PageNotFoundError = class extends Error {
                    constructor(e) {
                        super(),
                            (this.code = 'ENOENT'),
                            (this.message =
                                'Cannot find module for page: '.concat(e));
                    }
                }),
                ...
                (I = function (e) {
                    e.forEach(function (e) {
                        e.interactionId &&
                            ...
                            (A = (T = Math.max(T, e.interactionId))
                                ? (T - L) / 7 + 1
                                : 0));
                    });
                }),
        ...
        9423: function (e, t) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.isAPIRoute = function (e) {
                    return (
                        '/api' === e ||
                        Boolean(null == e ? void 0 : e.startsWith('/api/'))
                    );
                });
        },
        676: function (e, t, r) {
